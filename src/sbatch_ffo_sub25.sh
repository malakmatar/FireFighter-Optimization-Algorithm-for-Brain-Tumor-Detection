...
srun --ntasks=1 --cpu-bind=cores --gpu-bind=map_gpu:0 python -u src/ffo.py   --mode full   --data-dir .   --results-dir runs/ffo_final_sub25   --seed 42   --epochs-fixed-full 8   --subset-frac 0.25   --agents 10   --iters 999   --eval-budget 110   --cache ""   --dense-min 128 --dense-max 512   --dropout-min 0.25 --dropout-max 0.55   --lr-min 1e-5 --lr-max 5e-4   --batch-min 16 --batch-max 32   --l2-min 1e-6 --l2-max 1e-4
